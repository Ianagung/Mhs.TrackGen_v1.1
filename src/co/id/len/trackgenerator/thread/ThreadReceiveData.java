...
//    private final RadarParser radarParser;
    ...
    public ThreadReceiveData(ModelVariabel modVar, TrakGenerator tG, MessageController messageController1) {
        threadName = "Received";
        this.modelVariable = modVar;
        this.trackGenerator = tG;
        setSocket(modelVariable.getPortUdpRx());
...
//            databyte = inPacket.getData();
            ...
            if (structHeader.getTopic() == DEF.TOPIC_CCD2TG) {
                if (structHeader.getType_msg() == DEF.TYPE_TX_MSG && structHeader.getType_sub_msg() == DEF.MSG_TYPE_TEXT) {
//
...
//
                ...
                if (structHeader.getType_msg() == DEF.TYPE_TX_MSG && structHeader.getType_sub_msg() == DEF.MSG_TYPE_DEL_CIRCLE) {
                ...
                if (structHeader.getType_msg() == DEF.TYPE_TX_MSG && structHeader.getType_sub_msg() == DEF.MSG_TYPE_DEL_POLYLINE) {
                ...
                if (structHeader.getType_msg() == DEF.TYPE_TX_MSG && structHeader.getType_sub_msg() == DEF.MSG_TYPE_DRAW_CIRCLE) {
                ...
                if (structHeader.getType_msg() == DEF.TYPE_TX_MSG && structHeader.getType_sub_msg() == DEF.MSG_TYPE_DRAW_POLYLINE) {
                ...
                if (structHeader.getType_msg() == DEF.TYPE_TX_TRACK && structHeader.getType_sub_msg() == DEF.TRACK_TYPE_GPS) {
                    ...
                    modelVariable.getBuffer_trak_tx().add(0, struckModelTrack);
                    modelVariable.sortDataTrack();

//                    byte[] udpPacket = new byte[8 + messageData.length];
//
//                    udpPacket[0] = (byte) DEF.TOPIC_TG2CORE;
//                    udpPacket[1] = (byte) DEF.TYPE_TX_TRACK;
//                    udpPacket[2] = (byte) DEF.TRACK_TYPE_GPS;
//                    udpPacket[3] = (byte) source;
//                    udpPacket[4] = (byte) destination;
//                    System.arraycopy(messageData, 0, udpPacket, 8, messageData.length);
                    //Data dikirimkan ke Core Datalink
                    trackGenerator.kirimData(setDataTrackReadySend());

                    //Data ditampilkan ke text Area
                    messageController.produceMessage(new UdpRcvFromCcdTrackMessage(messageData));
